...
export const MappingFields = ({ contentTypeNames, mapping, mappingUpdated, disableEditing }:Props) => {
            ...
            { contentTypeNames && mappingLocal && (
                ...
                Object.entries(contentTypeNames).map(([fieldIndex,fieldName]) => {
                    ...
                    return (
                        ...
                        <>
                        { ((mappingLocal.fields && mappingLocal.fields[fieldName]) || !disableEditing) && (
